...
namespace Pong {
    public class Game {
        ...
        private TcpTrainer _trainerClient;
        ...
        public void Start() {
            ...
            _entities = new List<IEntity> {
                ...
                new Bat(
                    ...
                    position: new PVector2F(20 - BarWidth, height / 2 - BarHeight / 2),
            ...
            while (!closed) {
                ...
                if (state is PlayState && _trainerClient == null) _trainerClient = new TcpTrainer(this);

                if (state is PlayState) _trainerClient.Update();
